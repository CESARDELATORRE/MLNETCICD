...
namespace DetoxModel.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"../../../../../Data/wikiDetoxAnnotated40kRows.tsv";
        private static string MODEL_FILEPATH = @"../../../../DetoxModel.Model/MLModel.zip";
        ...
        public static void CreateModel()
        {
            ...
            // Save model
            SaveModel(mlContext, mlModel, GetAbsolutePath(MODEL_FILEPATH), trainingDataView.Schema);
        }
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options() { L2Regularization = 0.788121f, L1Regularization = 0.7499517f, OptimizationTolerance = 0.0001f, HistorySize = 20, MaximumNumberOfIterations = 1935059996, InitialWeightsDiameter = 0.46832f, DenseOptimizer = false, LabelColumnName = "Label", FeatureColumnName = "Features" });
